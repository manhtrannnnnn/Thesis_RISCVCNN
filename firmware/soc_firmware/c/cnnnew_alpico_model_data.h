#ifndef CNNNEW_AL_PICO_MODEL_DATA_H
#define CNNNEW_AL_PICO_MODEL_DATA_H

#include <stdint.h>

#if defined(CNNNEW_TEST) || defined(CNNNEW_RUN)
    /* Partial-Sum Storage */
    extern int32_t cnnnew_conv0_ps_data[];
    extern int32_t cnnnew_conv1_ps_data[];
    extern int32_t cnnnew_dense0_ps_data[];
